...
public class Plasma extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Point displaySize = ViewUtils.canvasSizeWH(this);
...
class PlasmaView extends View {
    ...
    public PlasmaView(Context context, int width, int height) {
        ...
        mStartTimeMillis = TimeUnit.NANOSECONDS.toMillis(System.nanoTime());
    }

    @Override protected void onDraw(Canvas canvas) {
        renderPlasma(mBitmap, TimeUnit.NANOSECONDS.toMillis(System.nanoTime()) - mStartTimeMillis);
